...
type UnionAssets<T, U> = NoDistrubute<T> extends U ? true : false

type T8 = UnionAssets<1 | 2, 1 | 2 | 3>
type T9 = UnionAssets<1 | 2 | 3, 1 | 2>

// 如果判断两个类型完全相等
type IsEqual<T, U, Success, Fail> = NoDistrubute<T> extends U
  ? (NoDistrubute<U> extends T
    ? Success
    : Fail)
  : Fail
...
type isNever<T> = NoDistrubute<T> extends never ? true : false
